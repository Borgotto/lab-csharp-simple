    ...
    public class Map2D<TKey1, TKey2, TValue> : IMap2D<TKey1, TKey2, TValue>
    {
        ...
        public IList<Tuple<TKey2, TValue>> GetRow(TKey1 key1)
        {
            return this.data.Keys
                ...
                .Select(tuple => Tuple.Create(tuple.Item2, data[tuple]))
                .ToList();
        }
        ...
        public IList<Tuple<TKey1, TValue>> GetColumn(TKey2 key2)
        {
            return this.data.Keys
                ...
                .Select(tuple => Tuple.Create(tuple.Item1, data[tuple]))
                .ToList();
        }
        ...
        {
            return data.Keys
                .Select(tuple => Tuple.Create(tuple.Item1, tuple.Item2, data[tuple]))
                .ToList();
        }
        ...
        public void Fill(IEnumerable<TKey1> keys1, IEnumerable<TKey2> keys2, Func<TKey1, TKey2, TValue> generator)
        {
            foreach(var key1 in keys1)
            {
                ...
                {
                    data.Add(Tuple.Create(key1, key2), generator(key1, key2));
                }
            }
        }
